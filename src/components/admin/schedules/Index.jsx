  ...
  render() {
    const schedules = this.state.schedule.map((schedule) =>
      <tr>
        ...
        <td>{schedule.time}</td>
        <td>
          <Link to={'/admin/agendamento/'+schedule.id} className="btn-actions btn-edit" title="editar"><i className="fas fa-edit"></i></Link>
    ...
    return (
      <div>
        <h1>Agendamentos</h1> 
        <Link to="/admin/agendamento/novo" className="btn btn-save btn-new">Cadastrar novo</Link>
